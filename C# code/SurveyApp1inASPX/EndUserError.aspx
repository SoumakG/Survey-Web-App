<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndUserError.aspx.cs" Inherits="SurveyApp1inASPX.EndUserError" %>
...
<body>
    ...
    <div class="SIU1" style="margin :40px">
        <h2>
            Ion <strong style="color: Red">Survey</strong></h2>
        <div class="SIU2" style="width: 62%; height: 55%; text-align:center">
         <div style=" vertical-align: middle;"> <h1 style="line-height:113px;vertical-align: middle;"> You Have Already Taken IonSurvey.</h1> <h2>Please wait for next survey to be released</h2></div>
        </div>
    </div>
    <footer>
